(function (g) {
  ...
  function x(a) {
    r === q &&
      (r =
        -1 ===
        v
          .serializeToString(g.parseXML(n["xl/worksheets/sheet1.xml"]))
          .indexOf("xmlns:r"));
      ...
      if (g.isPlainObject(d)) x(d);
        ...
        if (r) {
          ...
          for (e = c.attributes.length - 1; 0 <= e; e--) {
            ...
            -1 !== f.indexOf(":") &&
              (h.push({ name: f, value: i }), c.removeAttribute(f));
          }
          e = 0;
  ...
  j.ext.buttons.excelFlash = g.extend({}, u, {
    ...
    action: function (a, b, d, c) {
            ...
            i ||
              ...
              (a[b].match &&
                ...
                : ((n = !a[b].replace
                  ...
                  (i = o(f, "c", {
                    attr: { t: "inlineStr", r: j },
                    children: {
                      row: o(f, "is", {
                        children: { row: o(f, "t", { text: n }) },
                      }),
                    },
                  }))));
            l.appendChild(i);
      ...
      c.footer &&
        i.footer &&
        (j(i.footer, e), g("row:last c", f).attr("s", "2"));
      ...
      for (s = i.header.length; m < s; m++)
        j.appendChild(
          o(f, "col", {
            attr: { min: m + 1, max: m + 1, width: C(i, m), customWidth: 1 },
          })
        );
